...
BRANCH_ID = "0.0.1.18"
WORD_TEMPLATE = "./src/Word_DOC_Builder/Word_Doc_Process_Template_CASE_3 (DE).docx"

docBuilder = WordDocBuilder(TOPICS_PATH + "/Clusters", TREE_PATHNAME, BRANCH_ID, show_progress_bar=True, log_json=True,
