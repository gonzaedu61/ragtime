...
# ------------------------------------------------------------
# Query expansion (language-agnostic)
# ------------------------------------------------------------
...
async def query_rag(request: QueryRequest) -> QueryResponse:
    ...
    # 2) Use query as-is for retrieval (multilingual embeddings)
    ...
    prompt = build_context_prompt(query_for_db, reranked_chunks, input_lang)
