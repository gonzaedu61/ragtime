...
SOURCE_FILENAME = "auf_pos.docx"
OUTPUT_FILENAME = "auf_pos_(rewritten).docx"
...
RULES:
  ...
  - Only allowed addition: When finding a too technical, jargon, or system specific term, please add a more friendly explanation of what it is. Do not replace the term. Just complement it with an explanation/description.
