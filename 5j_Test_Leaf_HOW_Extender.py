...
LEAF_PROMPT = """
You are analyzing a set of text chunks and an input json structure all belonging to the same topic. The json file contains a field named "HOW" with a list of questions related to the topic.

TASK:
- For each question in the "HOW" field list generate a 4-8 statements answer using the provided texts as the knowledge source.
